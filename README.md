...
## Background
The R&D of this project has been in the works since November 2023. The orginal revision of the MFPV Project was finsihed in March 2024, using a mix of salvaged FPV parts and new parts to make a frankenstein of a drone. The project was a failure. The drone had major diffictlties taking off until it was time to present the prototype at a state engineering confrence. With a new configuration hopefully fixing the take off issues, the reciever happened to short itself, dying. I shelved the project, figuring out what could be done. I happened to join Hack Club at around 3 weeks after the confrence. Once Hack Hour evolved into Arcade, I was dead set on revising and publishing the project. And this is what came out of that determination.  
